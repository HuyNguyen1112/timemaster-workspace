                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <View style={styles.goalRow}>
                            ...
                            <View style={{ flexDirection: 'row', flex: 1, marginLeft: 12, gap: 8 }}>
                                <TouchableOpacity 
                                    style={[styles.unitBtn, unit === 'times' && styles.unitBtnActive]}
                                    onPress={() => setUnit('times')}
                                >
                                    <Text style={[styles.unitBtnText, unit === 'times' && styles.unitBtnTextActive]}>Lần</Text>
                                </TouchableOpacity>
                                <TouchableOpacity 
                                    style={[styles.unitBtn, unit === 'minutes' && styles.unitBtnActive]}
                                    onPress={() => setUnit('minutes')}
                                >
                                    <Text style={[styles.unitBtnText, unit === 'minutes' && styles.unitBtnTextActive]}>Phút</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
...
const styles = StyleSheet.create({
    ...
    unitBtn: { flex: 1, backgroundColor: Colors.background, borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: Colors.border },
